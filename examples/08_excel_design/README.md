...
- A workbook-style reference for the `validate-design` implementation and future `design-to-yaml` work.
...
- `validate-design` can validate the workbook, but `design-to-yaml` is still not implemented.
